...
import { type SavedBatchRunDetail, type SavedBatchCell } from "@/lib/savedBatches";
...
export default function BatchResults({
  ...
  const [ddCap, setDdCap] = useState(run.ddCap);
...
function EquityTip({ active, payload }: { active?: boolean; payload?: Array<{ dataKey?: string; value?: number }>; label?: string | number }) {
  if (!active || !payload?.length) return null;
